...
#define FST_OPERATOR 3,	\
	FST::NODE(11, FST::RELATION('+', 2), FST::RELATION('-', 2), FST::RELATION('*', 2), FST::RELATION('/',2), FST::RELATION('%', 2), FST::RELATION('>', 2), FST::RELATION('<', 2), FST::RELATION('>', 1), FST::RELATION('<', 1), FST::RELATION('~', 2), FST::RELATION('!', 2)),\
